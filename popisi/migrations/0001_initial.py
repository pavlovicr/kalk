    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('objekt', models.ManyToManyField(to='popisi.Objekt')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('podrocje', models.ManyToManyField(to='popisi.Podrocje')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='objekt',
            name='podrocje',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='popisi.Podrocje'),
        ),
        migrations.AddField(
            model_name='objekt',
            name='projekt',
